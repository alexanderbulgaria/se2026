 ...
 */
final class Version20260206192425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, author_id, title, content, created_at FROM post');
        ...
        $this->addSql('INSERT INTO post (id, author_id, title, content, created_at) SELECT id, author_id, title, content, created_at FROM __temp__post');
